...
from ..common_utils import AMHError
...
class AMHConfig(BaseConfig):
    ...
    def map_openai_params(
        ...
        for param, value in non_default_params.items():
            ...
            if param == "max_tokens":
                ...
                # Failed: Error occurred: HuggingfaceException - Input 
                # validation error: `max_new_tokens` must be strictly positive
                if value == 0:
                    value = 1
    ...
    def _transform_prompt(self, messages: List) -> list[dict]:
        return messages
    ...
    def transform_request(
        ...
        data: Dict = inference_params  # flatten inference params
